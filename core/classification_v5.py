        ...
        return {
            ...
            "0000_納付税額一覧表": {
                ...
                "exclude_keywords": [
                    ...
                    "事業税", "特別法人事業税", "地方法人税", "市役所", "県税事務所", "都税事務所"
                ],
            ...
            "2001_市町村_法人市民税": {
                ...
                "highest_priority_conditions": [
                    # 修正: 「当該市町村内」「市町村民税の特定寄附金」による法人市民税判定を最優先に
                    AndCondition(["当該市町村内", "市町村民税の特定寄附金"], "all"),
                    # バグ修正依頼書: C-1 市民税判定条件の強化
                    AndCondition(["法人市民税", "申告書", "市役所"], "all"),
                    # 既存条件も維持
                    AndCondition(["法人市民税申告書", "市役所", "均等割"], "all"),
                    AndCondition(["市町村民税", "法人税割", "申告納付税額"], "all"),
                    AndCondition(["法人市民税", "課税標準総額"], "all")
                ],
                "exact_keywords": ["法人市民税申告書", "市民税申告書"],
                "partial_keywords": [
                    "法人市民税", "市町村民税", "市役所", "町役場", "村役場",
                    # 市町村判定強化: 管轄表示と特定寄附金キーワードを追加
                    "当該市町村内", "市町村民税の特定寄附金"
                ],
                "exclude_keywords": [
