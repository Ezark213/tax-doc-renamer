...
class TaxDocumentRenamerGUI:
    ...
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("税務書類リネームシステム v3.1 修正版")
    ...
    def setup_file_tab(self):
        ...
        # ファイル選択エリア（ドラッグ&ドロップの代わりに大きなエリア）
        drop_frame = tk.Frame(self.file_tab, bg='lightgray', relief='dashed', bd=2, height=150)
    ...
    def setup_processors(self):
        ...
        self.debug_logger.log('INFO', "税務書類リネームシステム v3.1 修正版 起動")
